...
public class LoadImageWin extends JFrame {
    ...
    public void LoadImageWin() {
        ...
        status1 = new JTextField("Please import your image by click the <Load image> button");
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (option == JFileChooser.APPROVE_OPTION) {
                    ...
                    if (sf.length > 0) {
                        ...
                        status1.setText(imgname + " is chosen!");
                        img_index = 1;
                        try {
                            ...
                            status1.setText("can not display your image!");
                        }
                    } else {
                        imgname = null;
                        status1.setText("Please choose your image!");
                    }
                }
