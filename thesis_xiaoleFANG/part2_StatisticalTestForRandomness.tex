...
%
%Let us remark that, even though the Blum Blum Shum generator
%is cryptographically secure (which is a 
%property independent from the chosen modulo $m$),
%the very small value chosen for $m$ makes it
%unable to pass the NIST battery.
%Obviously, best statistical performances are obtained using the 
%proposed CIPRNG. Furthermore, this CIPRNG can also pass both the 
%DIEhard~and 
%TestU01 test suites. 
